...
@property (strong, nonatomic) NSLayoutConstraint *textFieldConstraint;
...
//
//
//    CGFloat textFieldConstant = 20;
//    self.textFieldConstraint = [self.myTextField.leftAnchor constraintEqualToAnchor:self.view.leftAnchor constant:textFieldConstant];
//
//    self.textFieldConstraint.active = YES;
//
////    NSLayoutConstraint *myConstraint = [NSLayoutConstraint constraintWithItem:self.myTextField attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeft multiplier:1 constant:20];
////    [self.view addConstraint:myConstraint];
////
////    myConstraint.constant = 500;
//
//
//    [self.myTextField.topAnchor constraintEqualToAnchor:self.view.topAnchor constant:20].active=YES;
//
//    textFieldConstant = 500;
//
//
...
- (IBAction)loginTapped:(id)sender {
    ...
    self.textFieldConstraint.constant = 100;
}
