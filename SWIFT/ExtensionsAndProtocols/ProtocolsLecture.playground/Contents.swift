...
class MyFavViewController: UIViewController, SomeProtocol {
...
extension Int: EmojiFun {
    
    func randomEmoji() -> String {
        if self == 5 { return "5"}
        return "Not five, i hate ou."
...
var officeJet = Printer(blackInk: 20.0, colorInk: 19.2, emojiProducer: littleFoot)
...
extension Baby: CustomStringConvertible {
    
    var description: String {
        
        return "Ello \(self.name)"
    }
}
...
class PokemonVC: UIViewController, UITableViewDelegate {
